...
export default function PhotosUploader({ addedPhotos, onChange }: PhotosUploaderType) {
    ...
    function removePhoto(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, filename: string) {
        e.preventDefault()
        onChange([...addedPhotos.filter(photo => photo !== filename)])
    }

    function selectAsMainPhoto(e: React.MouseEvent<HTMLButtonElement, MouseEvent>, filename: string) {
        e.preventDefault()
